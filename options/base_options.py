...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--attn_height_top_k', type=int, default=8, help='number of top indices to select along height, for the attention pruning')
        parser.add_argument('--attn_width_top_k', type=int, default=8, help='number of top indices to select along width, for the attention pruning')
        parser.add_argument('--ffn_dim_multiplier', type=int, default=4, help='expansion factor of feedforward')
        parser.add_argument('--attn_dropout', type=float, default=0.1, help='attention dropout')
        parser.add_argument('--ffn_dropout', type=float, default=0.1, help='feedforward dropout')
