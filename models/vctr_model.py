...
class CVCModel(BaseModel):
    """
    The code borrows heavily from the PyTorch implementation of CVC
    https://github.com/Tinglok/CVC
    """
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--flip_equivariance', type=util.str2bool, nargs='?', const=True, default=False, help="Enforce flip-equivariance as additional regularization. It's used by CUT, but not CVC")
